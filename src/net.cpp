...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("Cryptojournal-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("Cryptojournal-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("Cryptojournal-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Cryptojournal " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    	{ "cjseeder1.cryptojournal.news" , "cjseeder1.cryptojournal.news" },
		{ "cjseeder2.cryptojournal.news" , "cjseeder2.cryptojournal.news" }
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("Cryptojournal-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("Cryptojournal-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("Cryptojournal-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("Cryptojournal-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Cryptojournal is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("Cryptojournal-start");
