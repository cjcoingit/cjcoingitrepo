...
StakeForMultisendDialog::StakeForMultisendDialog(QWidget *parent) :
    QDialog(parent, (Qt::WindowMinMaxButtonsHint|Qt::WindowCloseButtonHint)),
    ui(new Ui::StakeForMultisendDialog),
	 model(0)
{
    ui->setupUi(this);
...
void StakeForMultisendDialog::setModel(WalletModel *model)
{
	this->model = model;
}

void StakeForMultisendDialog::setAddress(const QString &address)
{
	setAddress(address, ui->multisendAddressEdit);
}

void StakeForMultisendDialog::setAddress(const QString &address, QLineEdit *addrEdit)
{
	addrEdit->setText(address);
	addrEdit->setFocus();
}

void StakeForMultisendDialog::on_addressBookButton_clicked()
{
...
void StakeForMultisendDialog::on_viewButton_clicked()
{
...
void StakeForMultisendDialog::on_addButton_clicked()
{
...
void StakeForMultisendDialog::on_deleteButton_clicked()
{
...
void StakeForMultisendDialog::on_activateButton_clicked()
{
	std::string strRet = "";
...
void StakeForMultisendDialog::on_disableButton_clicked()
{
	std::string strRet = "";
