...
const string strMessageMagic = "Cryptojournal Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Cryptojournal", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "CryptoJournal. Your all in one soure of real-time crypto news";
        CTransaction txNew;
        txNew.nTime = 1491213019;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1491213019;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2050480;
		if(fTestNet)
        {
            block.nNonce   = 2050480;
        }
     	
		uint256 nhashMerkleRoot = uint256("c6ffc40937a72f0b2460d486e9631f45e4e288d3c02849dfec7a0717e2d23c2f");
